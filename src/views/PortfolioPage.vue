    ...
    return {
      projects: [
        ...
        },
        {
          title: "Wasabii",
          description:
            "An Apex Legends Stat Collection and Analysis tool, built with Vue.js, Python, and SQL. Collects and processes information about gameplay using CV2.",
          link: "https://github.com/rspet123/apexauto",
          technologies: ["Vue.js", "Python", "SQL", "CV2"],
          isPrivate: true,
          more: "I made this tool on the request of a friend who was working as an analyst for a pro Apex Legends team. It's a full stack project that handles data collection, processing & analysis, and can present an analyst or coach and their players with actionable information much quicker than a human analyst would be able to. Currently private, being used by a pro Analyst. He estimates it saves him over 30 hours a week.",
        },
        {
          title: "NinerScrims",
          description:
            "A tool to analyze CSGO (& CS2) demos/replays, built with Python and SKlearn, sorts players by role, skill, and performance. Used to recruit players for a Collegiate CS2 (and formerly CS:GO) team.",
          link: "https://github.com/rspet123/CS-GO-Stats-Analysis",
          technologies: ["Python", "SKLearn"],
          more: "I'm Passionate about eSports, and especially Counter Strike, I made this tool to help my college's CSGO team recruit players. It analyzes the replays from tryouts and sorts players by role, skill, and performance. It takes a lot of the grunt work out of recruiting and demo watching.",
        },
        {
          title: "RelayRace",
          description:
            "A tool to track enemy spies in EVE Online via their discord activity, Currently Private, Being used by a Large EVE Online Alliance",
          link: "",
          technologies: ["Python", "MongoDB", "SKLearn"],
          isPrivate: true,
          more: "EVE Online is incredibly serious and competitive game, and counter-intelligence is a big part of that, especially out of the game itself. I made this tool to help the leader of a large alliance (1000+ Members) track enemy spies. It uses the Discord API to track activity and uses SKLearn to analyze the data. I can't tell you how it works here, but it has already been quite successful.",
        },
        {
            title: "Atlas",
            description:
        ...
        },
        {
          title: "And More!",
          description:
            "I'm always working on new projects, they'll end up here if they're interesting enough.",
          link: "",
          technologies: ["Python", "AWS", "Go", "Generative AI"],
          more: "So come back later :).",
        }
      ],
    };
  },
